...
import BanyModal from "../components/Modals/BanyModal";
		...
		<div className={css(styles.container)}>
			<span className={css(styles.landHolder)}>
				...
				<div className={css(styles.factory)} onClick={handleFactoryOpen}>
					<Image src={factory} className={css(styles.imageStyle)} layout="fill" alt="" priority  />
				</div>
				<div className={css(styles.animals)} onClick={handleAnimalOpen}>
					<Image src={animals} layout="fill" alt="" priority className={css(styles.imageStyle)} />
				</div>
				<div className={css(styles.pool)} onClick={handlePoolOpen}>
					<Image src={pool} layout="fill" alt="" priority className={css(styles.imageStyle)} />
				</div>
				<div className={css(styles.pirate)} onClick={handlePirateOpen}>
					<Image src={pirate} layout="fill" alt="" priority className={css(styles.imageStyle)} />
				</div>
			</span>
		</div>
